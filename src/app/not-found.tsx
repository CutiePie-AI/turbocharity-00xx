...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 text-center">
      ...
      {/* Search suggestion */}
      <div className="mx-auto mt-8 w-full max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <nav className="mt-10 flex flex-wrap justify-center gap-6">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 font-semibold text-primary transition-colors hover:text-blue-700"
        >
          <svg
            className="h-4 w-4"
            fill="none"
