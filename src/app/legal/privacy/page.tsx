...
export const metadata: Metadata = {
  ...
  description:
    "Learn how TurboCharity collects, uses, and protects your personal information. Covers CCPA, GDPR, data security, and your privacy rights.",
};
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 lg:px-8 lg:py-16">
        <article className="prose prose-gray max-w-none prose-headings:text-gray-900 prose-a:text-primary prose-strong:text-gray-900">
          {renderLegalContent(privacyPolicy)}
        </article>
      </main>
      <Footer />
    </>
