...
export const metadata: Metadata = {
  ...
  description:
    'Find answers to common questions about starting a 501(c)(3) nonprofit with TurboCharity. Learn about pricing, timelines, and state requirements.',
  openGraph: {
    title: 'Frequently Asked Questions | TurboCharity',
    description:
      'Find answers to common questions about starting a 501(c)(3) nonprofit with TurboCharity.',
    type: 'website',
  },
};
