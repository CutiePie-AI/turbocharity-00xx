          ...
          <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-400">
                Get the latest nonprofit tips and product updates.
              </p>
            </div>
            <NewsletterSignup dark className="md:max-w-sm" />
          </div>
        </div>

        {/* Bottom bar */}
        <div className="flex flex-col items-center gap-4 border-t border-gray-800 py-6 sm:flex-row sm:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://linkedin.com/company/turbocharity"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 transition-colors hover:text-white"
              aria-label="LinkedIn"
            ...
            <a
              href="https://github.com/turbocharity"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 transition-colors hover:text-white"
              aria-label="GitHub"
