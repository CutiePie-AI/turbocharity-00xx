...
const columns: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Email', href: 'mailto:hello@turbocharity.org' },
    ],
  },
];
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-12">
          ...
          <div className="col-span-2 md:col-span-6 lg:col-span-4">
            <Link href="/" className="inline-flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">TurboCharity</span>
            </Link>
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-gray-400">
              The fastest way to launch your nonprofit. AI-powered tools to take you from idea to
              501(c)(3) status with confidence.
            </p>
          </div>
